...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO SPESIES TUNNELING SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e "    SABAR COK LAGI CEK IZIN VPS MU !!"
echo -e " ›AUTHOR : ${green}TOMKET STORE® ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: SPESIES VPN ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
data_ip="https://raw.githubusercontent.com/yaudahhh/darkside/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/Hhehexixixi"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/yaudahhh/darkside/main/"
...
clear
izinsc="https://raw.githubusercontent.com/yaudahhh/darkside/main/ip"
# USERNAME
rm -f /usr/bin/user
